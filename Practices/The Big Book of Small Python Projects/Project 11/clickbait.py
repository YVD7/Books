"""Clickbait Head line Generaor, by Al Sweigart al@inventwithpython.com
...
NOUNS = ['Athelete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent', 
...
def main():
    print('Clickbait Headlline Generator')
    ...
    for i in range(numberOfHeadlines):
        ...
        if clickbaitType == 1:
            headline = generateAreMillinnialsKillinngHeadline()
        elif clickbaitType == 2:
            headline = generateWhatYouDontHeadline()
            ...
            headline == generateJobAutomationHeadline()
...
# Each of these functions returns a different type of headlines:
def generateAreMillinnialsKillinngHeadline():
    noun = random.choice(NOUNS)
    return 'Are Millennials Killing the {} Industry?'.format(noun)

def generateWhatYouDontHeadline():
    noun = random.choice(NOUNS)
...
def generateJobAutomationHeadline():
    state = random.choice(STATES)
    noun = random.choice(NOUNS)
